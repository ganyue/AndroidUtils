...
import com.gy.utils.audio.mpdplayer.mpd.Album;
import com.gy.utils.audio.mpdplayer.mpd.AlbumInfo;
import com.gy.utils.audio.mpdplayer.mpd.Artist;
import com.gy.utils.audio.mpdplayer.mpd.Directory;
import com.gy.utils.audio.mpdplayer.mpd.FilesystemTreeEntry;
import com.gy.utils.audio.mpdplayer.mpd.Item;
import com.gy.utils.audio.mpdplayer.mpd.MPD;
import com.gy.utils.audio.mpdplayer.mpd.UnknownArtist;
...
public class Music extends Item implements FilesystemTreeEntry {
    ...
    protected Music(String album, String artist, String albumartist,
                    String fullpath, int disc, long date, long time,
                    String title, int totalTracks, int track, int songId, int pos, String name) {
        this.album = album;
        this.artist = artist;
    ...
    public static boolean isValidArtist(String artist) {
        return !isEmpty(artist) && artist.length() < MAX_ARTIST_NAME_LENGTH;
    }
